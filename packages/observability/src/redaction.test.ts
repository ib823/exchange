...
const SENSITIVE_FIELD_NAMES = [
  'privateKey', 'passphrase', 'password', 'token', 'accessToken',
  'refreshToken', 'apiKey', 'secretKey', 'authorization', 'Authorization',
  'bearerToken', 'serviceToken', 'vaultToken', 'webhookSecret',
  'signingSecret', 'keyMaterial', 'payload', 'privateKeyArmored',
  'sftpPrivateKey', 'sftpPassword', 'hmacSecret',
];
...
describe('Redaction configuration', () => {
  ...
  it.each(SENSITIVE_FIELD_NAMES)(
    'redacts sensitive field: %s',
    (field) => {
